    ...
    <section id="contact" className="mt-32 mb-24 max-w-4xl mx-auto px-6 md:px-0">
      ...
      <div className="mb-12 text-center">
        <ScrollReveal
          ...
          baseRotation={0}
          blurStrength={10}
          containerClassName="text-4xl font-bold text-white mb-2"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col justify-between">
          <div>
            <ScrollFade delay={0.2} toggleActions={keepVisible}>
              <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                <FiCpu className="animate-pulse text-neutral-400" /> 
            ...
            <ScrollFade delay={0.3} toggleActions={keepVisible}>
              <div className="p-4 border border-neutral-800 bg-neutral-900/50 rounded-lg mb-6">
                <div className="flex justify-between items-end h-12 gap-1">
                  {[40, 70, 30, 80, 50, 90, 20, 60, 40, 75, 35, 85].map((height, i) => (
                    <div 
                      key={i}
                      className="w-full bg-neutral-600 rounded-t-sm animate-pulse"
                      style={{ 
                        height: `${height}%`,
          ...
          <ScrollFade delay={0.4} toggleActions={keepVisible}>
             ...
             >
               <div className="w-10 h-10 border border-neutral-700 rounded-full flex items-center justify-center group-hover:border-white transition-colors">
                 <FiMail />
               </div>
        ...
        <form className="space-y-4">
          <ScrollFade delay={0.2} fromY={20} toggleActions={keepVisible}>
            <div className="group relative">
              <input 
                ...
                className="w-full bg-neutral-900/50 border border-neutral-800 rounded px-4 py-3 text-neutral-200 focus:outline-none focus:border-white focus:bg-neutral-900 transition-all duration-300 placeholder:text-neutral-600"
              />
            </div>
          </ScrollFade>
          ...
          <ScrollFade delay={0.4} fromY={20} toggleActions={keepVisible}>
            <div className="group relative">
              <textarea 
                ...
                className="w-full bg-neutral-900/50 border border-neutral-800 rounded px-4 py-3 text-neutral-200 focus:outline-none focus:border-white focus:bg-neutral-900 transition-all duration-300 placeholder:text-neutral-600 resize-none"
              />
            </div>
          </ScrollFade>
          ...
          <ScrollFade delay={0.5} fromY={20} toggleActions={keepVisible}>
            <button 
              type="button" 
              className="w-full group relative overflow-hidden bg-neutral-200 text-neutral-900 font-bold py-3 rounded hover:bg-white transition-all duration-300 ease-in-out hover:-translate-y-1 flex items-center justify-center gap-2"
            >
